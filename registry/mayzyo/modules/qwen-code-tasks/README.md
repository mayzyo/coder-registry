...
By default, the module configures Coder MCP in Qwen Code settings, disables Qwen telemetry and usage statistics in generated settings, and enables AgentAPI state persistence.
