...
By default, the module configures Coder MCP in Qwen Code settings, allows the `coder_report_task` tool for timeline updates, disables Qwen telemetry and usage statistics in generated settings, and enables AgentAPI state persistence.
